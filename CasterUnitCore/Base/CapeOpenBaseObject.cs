...
namespace CasterUnitCore
{
        ...
        //,ECapeRoot, ECapeUnknown, ECapeUser
    {
        ...
        public string ComponentName
        {
            ...
            {
                if (!CanRename)
                    throw new ECapeInvalidOperationException(ComponentName + ": This Class cannot rename.");
                _name = value;
                Dirty = true;
            }
        }
        ...
        #region ECapeRoot Obsolete

        //public string name { get { return _errorDesc; } }

        #endregion

        #region ECapeUser Obsolete
        /*
        ...
        protected void SetError(string errorDesc, string errorIface, string errorScope)
        {
