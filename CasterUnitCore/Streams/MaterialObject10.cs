...
namespace CasterUnitCore
{
    ...
    public class MaterialObject10 : MaterialObject
    {
        ...
        public override void Destroy()
        {
            ...
            _capeThermoPropertyPackage = null;
        }
        ...
        public override Phases[] GetListOfAllowedPhase(out string[] phaseAggregationList, out string keyCompoundId)
        {
            ...
            {
                Debug.WriteLine("Allowed phase not found, use Vapor and Liquid. {0}", e.Message);
        ...
        public override Phases[] GetListOfPresentPhases(out PhaseStatus[] presentPhaseStatus)
        {
            object phaseLabel;
        ...
        public override void SetListOfPresentPhases(IEnumerable<Phases> presentPhases, IEnumerable<PhaseStatus> presentPhasesStatus)
        {
            throw new Exception("CO1.0 cannot set PresentPhases");
        }
