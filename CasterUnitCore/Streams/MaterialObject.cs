...
namespace CasterUnitCore
{
        ...
        : IDisposable
    {
        ...
        /// <summary>
        /// A string array used to make CompoundList faster, avoid calling Thermo System, contains the aliasName of compound
        /// </summary>
        ...
        /// <summary>
        /// Disconnect COM component, release the COM component
        /// </summary>
        ...
        public abstract Phases[] GetListOfPresentPhases(out PhaseStatus[] presentPhaseStatus);
        /// <summary>
        /// set present phase, unavailable for CO1.0
        /// </summary>
        public abstract void SetListOfPresentPhases(IEnumerable<Phases> presentPhases, IEnumerable<PhaseStatus> presentPhasesStatus);
        /// <summary>
        ...
        public Phases[] PresentPhases
        {
            get
            {
                PhaseStatus[] obsolete;
                return GetListOfPresentPhases(out obsolete);
            }
            set
            {
                PhaseStatus[] status = new PhaseStatus[value.Length];
                for (int i = 0; i < status.Length; i++)
                {
                    status[i] = PhaseStatus.Cape_UnknownPhaseStatus;
                }
            ...
            Dictionary<string, double> composition)
        {
            ...
            _alreadyFlashed = false;    //万一闪蒸出错了呢
            return DoTPFlash();
        }
