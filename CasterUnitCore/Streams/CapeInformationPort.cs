    ...
    public class CapeInformationPort : CapeUnitPort, IEnumerable<ICapeParameter>
    {
        ...
        public override void Connect(object objectToConnect)
        {
            ...
            if (objectToConnect is ICapeCollection)
            {
                ...
                throw new ECapeBadArgumentException("object connected to information port must be ICapeCollection", 0);
        }
        ...
        {
            return new CapeInformationPort(ComponentName, _portDirection, ComponentDescription, CanRename)
            {
