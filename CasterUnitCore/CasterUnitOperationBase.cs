...
namespace CasterUnitCore
{
        ...
        : CapeOpenBaseObject, ICapeUnit, ICapeUtilities, IPersistStream  //The origin CAPE-OPEN IPersistStream has a problem, so overload it
    {
        ...
        /// <summary>
        /// Happen during Initialize
        /// </summary>
        public event Action OnInitialize;
        /// <summary>
        /// Happen during Terminate
        /// </summary>
        public event Action OnTerminate;
        /// <summary>
        /// Happen when COSE ask for Parameters interface
        /// </summary>
        public event Action<CapeCollection> OnGetParameters;
        /// <summary>
        /// Happen when COSE ask for ports interface
        /// </summary>
        ...
        /// <summary>
        /// Default action is to check whether all ports is connected, override to customize
        /// </summary>
        protected virtual bool PortsValidate(out string message)
        {
            ...
            {
                if (!((CapeUnitPort)port.Value).IsConnected())
                {
                    message += "Port " + port.Key + " is not connected.";
                    valid = false;
                }
            }
            if (valid) return true;
        ...
        /// <summary>
        /// raw simulationContext interface called by simulator
        /// </summary>
